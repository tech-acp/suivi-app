                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            title:
                                                                                Text('Confirmation'),
                                                                            content:
                                                                                Text('Vous êtes sur le point de démarrer le suivi de l\'épreuve. Votre temps sera calculé à partir de maintenant.'),
                                                                            actions: [
                                                                              TextButton(
                                                            ...
                                                            var confirmDialogResponse =
                                                                await showDialog<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              Text('Annuler le dernier checkpoint'),
                                                                          content:
                                      ...
                                      if (mapPageRegistrationsRecord!.started ??
                                          true)
                                        Card(
                                          clipBehavior:
