    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'distance':
          ...
          break;
        case 'supabase_id':
          result.supabaseId = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class EventsRecordBuilder
  ...
  String? _supabaseId;
  String? get supabaseId => _$this._supabaseId;
  set supabaseId(String? supabaseId) => _$this._supabaseId = supabaseId;
